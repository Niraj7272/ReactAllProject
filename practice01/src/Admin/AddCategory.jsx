...
const AddCategory = () => {
  ...
  return (
    <div className='bg-gray-600'>
        <div className='bg-white h-[22rem] w-[40rem] mt-[5rem]  ml-[7rem]'>
            ...
            <div className='ml-[3rem] mt-[2rem] flex gap-[2rem]'>
                <div>
                    ...
                    <input type="text" name="category_title" onChange= {handleChange} required className='border-2 border-gray-400 h-[2.5rem] w-[34rem] pl-[2rem] rounded-[5px] mt-[0.6rem]' />
                </div>
            </div>
            <div>
                <button className=' h-[4rem] w-[15rem] rounded-[5px] mt-[4rem] ml-[22rem] bg-green-500 cursor-pointer font-bold text-white text-2xl'>Add</button>
            </div>
