...
const Registration = () => {
  ...
  return (
    ...
    <div className='bg-white h-[35rem] w-[25rem] shadow-black shadow-2xl'>
        ...
        <div className='ml-[3rem] mt-[2rem]'>
            ...
            <input type="password" value={user.cpassword} placeholder='Conform Your Password' name='cpassword' onChange={handleChange} className='bg-white w-[19rem] h-[2.5rem] mt-[1rem] pl-[1rem]  border-gray-500 border-[1px] rounded'/>
        </div>
        <div>
            <button className='bg-blue-600 w-[19rem] h-[2.5rem] mt-[6rem] pl-[1rem] font-bold rounded ml-[3rem]' onClick={handleClick}>Sign Up</button>
        </div>
    </div>
    </div>
  )
