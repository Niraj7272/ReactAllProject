...
const Detail = () => {
  return (
    <div className="bg-gray-400 h-screen w-screen">
      <h1 className="text-gray-900 font-bold text-[1.3rem]">Detail Page</h1>
      <div className="bg-white h-[25rem] w-[80rem] ml-[2rem] mt-[6rem] absolute">
        <div className="flex">
        <img
          ...
          className="h-[25rem]"
        />
        <h1 className="text-[2rem] font-bold text-gray-500 bg-gray-200 ml-[2rem] mt-[2rem] rounded pl-[10rem] h-[4rem] w-[50rem]">Wild Stone</h1>
        </div>
